/**
 * Tool registry for proto-agent-server.
 *
 ...
 * 1. **Shared tools** from `proto-agent-tools` — reusable across MCP,
...
import { ToolRegistry, searchWebTool } from 'proto-agent-tools';
import type { SharedTool } from 'proto-agent-tools';
