...
```typescript
import { defineSharedTool } from 'proto-agent-tools';
...
```typescript
import { ToolRegistry } from 'proto-agent-tools';
...
```typescript
import { toMCPTools } from 'proto-agent-tools/adapters/mcp';
...
```typescript
import { toLangGraphTools } from 'proto-agent-tools/adapters/langgraph';
...
```typescript
import { createToolNode } from 'proto-agent-flows';
...
```typescript
import { toExpressRouter } from 'proto-agent-tools/adapters/express';
...
The package ships example tools in `proto-agent-tools/examples`:

```typescript
import { getWeatherTool, searchWebTool } from 'proto-agent-tools/examples';
```
...
```typescript
// Core types exported from proto-agent-tools
export type { SharedTool, ToolResult, ToolContext, ToolRegistry };

// Adapter types
export type { MCPTool } from 'proto-agent-tools/adapters/mcp';
```
