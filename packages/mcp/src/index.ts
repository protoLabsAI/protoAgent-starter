#!/usr/bin/env node
/**
 * MCP server for proto-agent.
 *
 * Exposes registered tools via the Model Context Protocol over stdio.
 *
 * ## Connect to Claude Code
 * Add to ~/.claude/settings.json → mcpServers:
 *   "proto-agent": { "command": "node", "args": ["/path/to/packages/mcp/dist/index.js"] }
 *
 ...
 *   "proto-agent": { "command": "npx", "args": ["tsx", "/path/to/packages/mcp/src/index.ts"] }
 *
 * ## Adding tools
 *   import { myTool } from 'proto-agent-tools';
...
import { ToolRegistry, toMCPTools, getWeatherTool, searchWebTool } from 'proto-agent-tools';
