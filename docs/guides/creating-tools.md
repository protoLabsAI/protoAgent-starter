...
Tools in this starter kit use `defineSharedTool` from `proto-agent-tools`. One definition automatically produces three runtime targets:
...
import { searchDocsTool } from 'proto-agent-tools/examples';
// or your own tool:
